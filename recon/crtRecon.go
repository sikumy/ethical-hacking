...
func main() {
        ...
        domainArg := flag.String("d", "", "Domain name for the HTTP request")
        orgArg := flag.String("org", "", "Organization name for the HTTP request")
        ...
        for _, cert := range certificates {
                if *domainArg != "" {
                        // For domain queries, add both CommonName and NameValue
